...
## 更新摘要
**变更内容**
- 更新模块依赖关系分析，反映iris-layout独立于iris-gpu的新架构
- 修正布局引擎与渲染引擎的单向依赖关系图
- 新增消除循环依赖的技术说明
- 更新架构图以体现清晰的分层结构
...
**章节来源**
- [crates/iris-js/Cargo.toml:1-14](file://crates/iris-js/Cargo.toml#L1-L14)
...
**图表来源**
- [crates/iris-sfc/Cargo.toml:20-28](file://crates/iris-sfc/Cargo.toml#L20-L28)

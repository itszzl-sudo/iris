...
**更新** 布局引擎iris-layout已成功移除对iris-gpu的依赖，实现了与渲染器的完全解耦。这一架构重构使得布局计算不再依赖GPU初始化，提升了系统的灵活性和可维护性。
...
**图表来源**
- [lib.rs:17-23](file://crates/iris-layout/src/lib.rs#L17-L23)
...
**图表来源**
- [lib.rs:25-32](file://crates/iris-layout/src/lib.rs#L25-L32)

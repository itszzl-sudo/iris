...
- 更新了架构概览以反映运行时按需编译架构
- 新增了编译缓存管理系统的详细分析
- 完善了HTTP服务器和路由系统的架构说明
- 增加了HMR热模块替换功能的完整实现分析
- 更新了与iris-jetcrab-engine的深度集成说明
- 新增了WebSocket通信和文件监听机制
...
- **路由系统**：完整的路由处理机制，支持 Vue 模块编译和静态资源服务
...
**图表来源**
- [server/http_server.rs:20-103](file://crates/iris-jetcrab-cli/src/server/http_server.rs#L20-L103)
- [server/compiler_cache.rs:61-95](file://crates/iris-jetcrab-cli/src/server/compiler_cache.rs#L61-L95)

**章节来源**
- [server/http_server.rs:1-104](file://crates/iris-jetcrab-cli/src/server/http_server.rs#L1-L104)
...
**图表来源**
- [server/compiler_cache.rs:20-59](file://crates/iris-jetcrab-cli/src/server/compiler_cache.rs#L20-L59)
- [server/compiler_cache.rs:97-165](file://crates/iris-jetcrab-cli/src/server/compiler_cache.rs#L97-L165)
...
编译缓存系统还实现了智能的依赖树管理，用于检测项目依赖的变化：

**章节来源**
- [server/compiler_cache.rs:1-223](file://crates/iris-jetcrab-cli/src/server/compiler_cache.rs#L1-L223)
...
**图表来源**
- [server/http_server.rs:19-103](file://crates/iris-jetcrab-cli/src/server/http_server.rs#L19-L103)
...
**章节来源**
- [server/http_server.rs:58-70](file://crates/iris-jetcrab-cli/src/server/http_server.rs#L58-L70)
- [server/routes.rs:22-146](file://crates/iris-jetcrab-cli/src/server/routes.rs#L22-L146)
...
**章节来源**
- [server/routes.rs:1-344](file://crates/iris-jetcrab-cli/src/server/routes.rs#L1-L344)
...
**图表来源**
- [server/hmr.rs:71-206](file://crates/iris-jetcrab-cli/src/server/hmr.rs#L71-L206)
...
**图表来源**
- [server/hmr.rs:99-197](file://crates/iris-jetcrab-cli/src/server/hmr.rs#L99-L197)

**章节来源**
- [server/hmr.rs:1-207](file://crates/iris-jetcrab-cli/src/server/hmr.rs#L1-L207)
...
- [iris-jetcrab-engine/Cargo.toml:13-69](file://crates/iris-jetcrab-engine/Cargo.toml#L13-L69)

**章节来源**
- [Cargo.toml:1-54](file://crates/iris-jetcrab-cli/Cargo.toml#L1-L54)
- [iris-jetcrab-engine/Cargo.toml:1-69](file://crates/iris-jetcrab-engine/Cargo.toml#L1-L69)
...
该工具为 Vue 项目的开发提供了坚实的基础，随着后续版本的迭代，相信会成为开发者的重要生产力工具。其创新的运行时按需编译架构和智能缓存系统为现代前端开发提供了新的思路和解决方案。